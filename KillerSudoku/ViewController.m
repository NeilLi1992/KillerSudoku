...
- (void)drawBoardLines {
    ...
    for (int i = 0; i < 4; i++) {
        UIView* horiLineView = [[UIView alloc] initWithFrame:CGRectMake(0, 20 + i * cellLength * 3, self.view.bounds.size.width, 2)];
    ...
    // add vertical lines
    for (int i = 0; i < 3; i++) {
        UIView* vertiLineView = [[UIView alloc] initWithFrame:CGRectMake(i * cellLength * 3, 20, 2, self.view.bounds.size.width)];
        vertiLineView.backgroundColor = [UIColor blackColor];
        vertiLineView.layer.zPosition = 10;
        [self.view addSubview:vertiLineView];
    }
    UIView* vertiLineView = [[UIView alloc] initWithFrame:CGRectMake(3 * cellLength * 3 - 2, 20, 2, self.view.bounds.size.width)];
    vertiLineView.backgroundColor = [UIColor blackColor];
    vertiLineView.layer.zPosition = 10;
    [self.view addSubview:vertiLineView];
...
- (void)drawBoardCells {
    ...
    for (int i = 0; i < 9; i++) {
        ...
        for (int j = 0; j < 9; j++) {
            ...
            UIView* cellView = [[UIView alloc] initWithFrame:CGRectMake(j * cellLength, 20 + i * cellLength, cellLength, cellLength)];
